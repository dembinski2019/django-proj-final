...
class Veiculo(models.Model):
    ...
    def __str__(self):
        return f'{self.marca.nome} - {self.cor} - {self.placa}'
...
class MovRotativo(models.Model):
    ...
    def horas_total(self):
        calcSegundos = (self.checkout - self.checkin).total_seconds()/3600
        return math.ceil(calcSegundos)
